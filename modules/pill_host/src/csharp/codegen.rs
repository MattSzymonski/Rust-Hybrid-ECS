...
//! # Responsibilities
//!
//! - Generate `generated/<module>_Components.g.cs` inside each extension
...
/// Generate `<module>_Components.g.cs` inside the extension's `generated`
...
mod tests {
    ...
    /// The generated mirror must sit inside the extension's own
