use crate::{
    components::{
        BoxCollider, CollisionMoverScript, LoggerScript, MoverScript, Name, Position,
        SilentCollisionMoverScript, Velocity,
    },
...
trait_type_map::impl_trait_accessible!(dyn Component; Position, Velocity, Name, BoxCollider, SilentCollisionMoverScript);
...
pub fn run_performance_test_scripts() {
    ...
    for run in 1..=10 {
        ...
        world.register_component_type::<SilentCollisionMoverScript>();
        ...
        for i in 0..num_movers {
            ...
            world.add_component(entity, SilentCollisionMoverScript { speed: 1.0 });
        }
